...
public class AuthUserEntityRowMapper implements RowMapper<AuthUserEntity> {
    ...
    public AuthUserEntity mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        result.setAccountNonExpired(rs.getBoolean("account_not_expired"));
        result.setAccountNonLocked(rs.getBoolean("account_not_locked"));
        result.setCredentialsNonExpired(rs.getBoolean("credentials_not_expired"));
