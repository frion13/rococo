...
public class PaintingJson {
    ...
    public static PaintingJson fromEntity(PaintingEntity entity) {
        MuseumJson museumJson = new MuseumJson(
                entity.getMuseumId(),
                null, // title not available in PaintingEntity
                null, // description not available in PaintingEntity
                null, // photo not available in PaintingEntity
                null  // geo not available in PaintingEntity
        );

        ArtistJson artistJson = new ArtistJson(
                entity.getArtistId(),
                null, // name not available in PaintingEntity
                null, // biography not available in PaintingEntity
                null  // photo not available in PaintingEntity
        );
